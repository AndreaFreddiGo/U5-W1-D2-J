package andrea_freddi.U5_W1_D2_J;

import andrea_freddi.U5_W1_D2_J.entities.*;
...
public class OrdersRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext(U5W1D2JApplication.class);
        try {
