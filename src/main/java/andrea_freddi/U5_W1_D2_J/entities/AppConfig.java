...
public class AppConfig {
    ...
    @Bean("Tavolo1")
    Table table1Bean(@Value("${seat.price}") double seatPrice) {
        return new Table(1, 5, true, seatPrice);
    }

    @Bean("Tavolo2")
    Table table2Bean(@Value("${seat.price}") double seatPrice) {
        return new Table(2, 4, true, seatPrice);
    }

    @Bean("Tavolo3")
    Table table3Bean(@Value("${seat.price}") double seatPrice) {
